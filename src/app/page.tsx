...
import { Center, Button, Box, Tabs, TabList, Tab, TabPanels, TabPanel, Select, ChakraProvider } from '@chakra-ui/react';
...
import P5Sketch from './components/P5Sketch';  // Import the P5Sketch component
...
export default function Page() {
  ...
  return (
    <ChakraProvider>
      <div>
        <Center>
          <P5Sketch />  {/* Add the P5Sketch component at the top */}
        </Center>
        <p className={styles.bgText}>
          Load Sound Visualizer <br></br>
          Mint with Starknet
        </p>
        <Center>
